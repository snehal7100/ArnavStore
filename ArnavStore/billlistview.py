...
from ArnavStore.posmaster.models import PosMaster  # Or wherever your model is
from ArnavStore.Customer.models import Customer  # If you use Customer model for the bill info
